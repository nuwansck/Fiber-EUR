...
# All config has moved to settings.json
# Load via: from bot import load_settings; s = load_settings()
SYMBOL = "EUR_USD"   # instrument name only — not a tunable parameter
